...
\hypersetup{
  pdftitle={Distribute data for STA2005S regression},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Distribute data for STA2005S regression}
\author{}
\date{}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, frame hidden, boxrule=0pt, interior hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, sharp corners]}{\end{tcolorbox}}\fi
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_raw\_ad }\OtherTok{\textless{}{-}}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{read\_csv}\NormalTok{(projr}\SpecialCharTok{::}\FunctionTok{projr\_path\_get}\NormalTok{(}\StringTok{"data{-}raw"}\NormalTok{, }\StringTok{"Advertising.csv"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_raw\_ad }\OtherTok{\textless{}{-}}\NormalTok{ data\_raw\_ad }\SpecialCharTok{|\textgreater{}}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\StringTok{\textasciigrave{}}\AttributeTok{...1}\StringTok{\textasciigrave{}}\NormalTok{)}
\NormalTok{data\_tidy\_ad }\OtherTok{\textless{}{-}}\NormalTok{ data\_raw\_ad}
\NormalTok{usethis}\SpecialCharTok{::}\FunctionTok{use\_data}\NormalTok{(data\_tidy\_ad, }\AttributeTok{overwrite =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
